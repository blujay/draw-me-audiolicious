...
public class PunMakeAudioLoopObject : MonoBehaviour
{
    ...
    public void StartRecording()
    {
        if (!generated)
        {
            ...
            recording = true;
            audioS.clip = Microphone.Start(Microphone.devices[0], true, loopDuration, 48000);  // third argument restricts the duration of the audio
