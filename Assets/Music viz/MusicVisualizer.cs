...
public class MusicVisualizer : MonoBehaviour {
    ...
    void Start () {
        ...
        {
            GameObject g = PhotonNetwork.Instantiate(barObject.name, transform.position, transform.rotation, 0);
            boxGenStartPointX = this.transform.position.x;
            g.transform.localPosition = new Vector3(boxGenStartPointX + barSpacing * i, this.transform.localPosition.y, 0);
